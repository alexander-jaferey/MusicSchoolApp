...
class Instructor(db.Model):
    ...
    courses: Mapped[List["InstructorCourseRelationship"]] = relationship(
        back_populates="instructor", cascade="all, delete-orphan"
    )
    instruments: Mapped[List["InstructorInstrumentRelationship"]] = relationship(
        back_populates="instructor", cascade="all, delete-orphan"
    )
...
class Course(db.Model):
    ...
    instructors: Mapped[List["InstructorCourseRelationship"]] = relationship(
...
class Instrument(db.Model):
    ...
    instructors: Mapped[List["InstructorInstrumentRelationship"]] = relationship(
        back_populates="instrument", cascade="all, delete-orphan"
    )
    courses = relationship(
        "Course", back_populates="instrument", cascade="all, delete-orphan"
    )
