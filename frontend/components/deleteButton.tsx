  ...
  async function handleDelete() {
      if (confirm("Are you sure you want to delete this instrument?")) {
        ...
        if (json.error) {
          ...
          alertService.error(`Could not delete instrument (error ${error}: ${errorMessage})`, { id: "main" })
        };
        
        alertService.success("Instrument deleted", { id: "main", keepAfterRouteChange: true })
        setTimeout(function() {
          router.push("/")
        }, 1000)
      };
