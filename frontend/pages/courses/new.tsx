...
import { CoursesQuery, IndexedStringList, InstructorsQuery, InstrumentsQuery } from "../../interfaces";
...
function Page({
  ...
  return (
    <Layout user={user} loading={isLoading}>
      <CourseForm method="POST" instruments={instruments} instructors={instructors} />
    </Layout>
  )
}
